...
function PlayingVideo() {
  ...
  console.log("This is video url", video)
              ...
              <div className="flex items-start">
                <div className="flex h-11 w-11 rounded-full overflow-hidden">
                  <img
                    ...
                    src={(video?.author?.avatar !== null) ? (video?.author?.avatar[0]?.url) : "https://c8.alamy.com/comp/2B06W66/initial-cs-letter-logo-with-creative-modern-business-typography-vector-template-creative-abstract-letter-cs-logo-design-2B06W66.jpg"}
                    alt="nope"
                  />
                </div>
              </div>
